...
contract FHERPS is SepoliaConfig {
    ...
    struct Game {
        ...
        bool gameSolved; // Flag to indicate if the game has been solved
    }
    ...
    // Bitwise mask for host winning plays
    ...
    function joinGameAndSubmitMove(uint256 gameId, externalEuint8 encryptedMove, bytes calldata inputProof) external {
        ...
        require(games[gameId].gameSolved == false, "Game already solved");
